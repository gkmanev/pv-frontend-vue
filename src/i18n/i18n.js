...
export default new VueI18n({
  ...
  messages: {
    en: {
      ...
      "Classy Dashboard": "Classy Dashboard",
    ...
    fr: {
      ...
      "Modern Dashboard": "Tableau de bord moderne",
      "Minimal Dashboard": "Tableau de bord minimal",
      "Awesome Dashboard": "Tableau de bord génial",
      "Classy Dashboard": "Tableau de bord élégant",
    ...
    ch: {
      Starter: "入门套件",
      "Modern Dashboard": "现代仪表板",
      "Minimal Dashboard": "最小仪表板",
      "Awesome Dashboard": "很棒的仪表盘",
      "Classy Dashboard": "优雅的仪表板",
    ...
    gr: {
      Starter: "Starter-Kit",
      "Modern Dashboard": "Modernes Dashboard",
      "Minimal Dashboard": "Minimales Dashboard",
      "Awesome Dashboard": "Tolles Dashboard",
      "Classy Dashboard": "Elegantes Dashboard",
